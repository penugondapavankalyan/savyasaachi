...
def build_system_prompt(context: StoreContext) -> str:
    ...
    if context.workflow_state == "UNREGISTERED":
        ...
        task_guidance = (
            ...
            "  ⚠️  bill_id: the finalize_bill result always starts with 'bill_id=<uuid>'.\n"
            "      Read that UUID and pass it exactly to cancel_bill / void_bill / confirm_payment.\n"
            "      NEVER invent a bill_id. NEVER pass bill_number — always the UUID.\n\n"
